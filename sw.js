...
const PRECACHE_URLS = [
  ...
  '/tabuleiro/js/tab-dadiva-sorteio.js',
  ...
  '/tabuleiro/js/tab-zoom-curso.js',
  ...
  '/shared/musica-capitulo.js',
  '/shared/audio-arquivo.js',
  '/shared/alcance-livros.js',
