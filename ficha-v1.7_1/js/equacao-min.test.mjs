...
const FICHA = {
    ...
    'FOR': 2, 'DES': 3,
    'Teto de Arma: Braço': 2,        // FOR 2, sem Domínio
    'Teto de Arma: Braço +10': 12,   // FOR 2, com Domínio
};
...
assert.equal(roda([Q, A, { op: 'min', tipo: 'ficha', ref: 'Teto de Arma: Braço' }, { op: '+', tipo: 'ficha', ref: 'FOR' }]), 4,
    'sem Domínio o Ofício rende até o atributo');

// Com o Domínio (+10 no teto): rende tudo — min(10, 12) + 2 = 12
assert.equal(roda([Q, A, { op: 'min', tipo: 'ficha', ref: 'Teto de Arma: Braço +10' }, { op: '+', tipo: 'ficha', ref: 'FOR' }]), 12,
    'com Domínio rende inteiro');

// Besta: potência fixa no lugar do atributo — min(10, 2) + 3 = 5
assert.equal(roda([Q, A, { op: 'min', tipo: 'ficha', ref: 'Teto de Arma: Braço' }, { op: '+', valor: 3 }]), 5,
...
assert.equal(roda([{ tipo: 'ficha', ref: 'nada' }, { op: '+', tipo: 'ficha', ref: 'nada2' },
    { op: 'min', tipo: 'ficha', ref: 'Teto de Arma: Braço' }, { op: '+', tipo: 'ficha', ref: 'FOR' }]), 2,
